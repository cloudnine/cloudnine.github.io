...
function renderResults(results) {
    ...
    results.slice(0, 100).forEach(function (result) {
        ...
        $resultstring += "</p>" +
            ...
            "<a href='" + result.permalink + "'><i class='fa fa-calendar-o'></i> " + moment(result.date).format('LL') + "</a>" +
            "</p>" +
            "</div>" +
            "<div class='intro'>" + result.summary + "</div>" +
            "<p class='read-more'><a href='" + result.permalink + "' class='btn btn-template-main'>Continue reading</a>" +
            "</p>" +
            "</div>" +
            "</div>" +
            "</section>";
