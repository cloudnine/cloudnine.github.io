...
var limit=30;var minChars=2;var searching=false;var render=function(results){results.sort(function(a,b){return b.weight-a.weight;});for(var i=0;i<results.length&&i<limit;i+=1){var result=results[i].item;var openAnchor="<a href=\""+result.permalink+"\" "+
"alt=\""+result.showTitle+"\">";var showImageUrl=result.showImage.replace(new RegExp(' ','g'),'\/');var resultPane='<article id=\"post-summary-grid\"class=\"post\">'+
